...
public class DictionaryDaoImpl implements DictionaryDao {
    ...
    private static final String GET_AREA = "SELECT * FROM jc_country_struct WHERE area_id like ? and area_id not like ?";
    ...
    private String buildParam(String areaId) throws SQLException {
        ...
        throw new SQLException("Invalid 'area_id' = " + areaId);
    }
}
